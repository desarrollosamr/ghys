...
<div class="row">
  ...
  <div class="form-group">
    ...
    <?php foreach($tallas as $talla):?>
      <option value="<?php echo $talla->id;?>"><?php echo $talla->name;?></option>
    <?php endforeach;?>
      </select>    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="unit" required class="form-control" id="unit" placeholder="Unidad del Producto" value="pza">
    </div>
  </div>

  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Stock minimo:</label>
    <div class="col-md-6">
      <input type="text" name="inventary_min" class="form-control" id="inputEmail1" placeholder="Stock minimo (Default 10)">
    </div>
  </div>
