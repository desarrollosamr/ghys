<?php
if(isset($_POST['id'])){
	$product = SellData::getByClientId($_POST["id"]);
}else{
	$product = SellData::getByClientId($_GET["id"]);
}
					...
					<tbody>
						<tr>
							<form>
								...
								<td id="">
									<input type="hidden" name="view" value="clientreport">
		...
		<div class="col-md-12">
			...
			<?php    if($_GET["sd"]!="" && $_GET["ed"]!=""):?>
				<table class="table table-hover table-bordered">
			  	<thead><th>Id</th><th>Producto</th><th>Cantidad</th><th>Tipo</th><th>Fecha</th></thead>	  				  	<?php foreach($product as $ventas):?>
