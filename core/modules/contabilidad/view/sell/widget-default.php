...
<table class="table table-bordered table-hover">
	...
	<tr class="<?php if($q<=$product->inventary_min){ echo "danger"; }?>">
		...
		<td><input type="" class="form-control" name="d" value="0" placeholder="Descuento ..."></td>
...
if(isset($_GET["id"]) && $_GET["id"]!=""){
	...
	$abono = 0;
	$abono = $sell->monto_e + $sell->monto_t;
...
<tr >
	...
	<td><b> <?php echo number_format($p["d"]); ?>%</b></td>
...
<div class="form-group">
    ...
    <?php if ($abono > 0){ ?>
    <label for="inputEmail1" class="col-lg-2 control-label">Abonó</label>
    <div class="col-lg-10">	
