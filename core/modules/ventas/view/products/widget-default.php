...
if($px>0):
	if(isset($_GET["product"])){?>
		<a class="btn btn-sm btn-default" href="<?php echo "index.php?view=products&limit=$limit&page=".($px)."&product=".$_GET["product"]; ?>"><i class="glyphicon glyphicon-chevron-left"></i> Atras </a>
<?php	}else{ ?>
		<a class="btn btn-sm btn-default" href="<?php echo "index.php?view=products&limit=$limit&page=".($px)."&product=".$_GET["product"]; ?>"><i class="glyphicon glyphicon-chevron-left"></i> Atras </a>		
<?php	}
 endif; ?>
...
if($px<=$npaginas):
	if(isset($_GET["product"])){?>
		<a class="btn btn-sm btn-default" href="<?php echo "index.php?view=products&limit=$limit&page=".($px)."&product=".$_GET["product"]; ?>">Adelante <i class="glyphicon glyphicon-chevron-right"></i></a>
<?php	}else{ ?>
		<a class="btn btn-sm btn-default" href="<?php echo "index.php?view=products&limit=$limit&page=".($px)."&product=".$_GET["product"]; ?>">Adelante <i class="glyphicon glyphicon-chevron-right"></i></a>
<?php		}
 endif; ?>
