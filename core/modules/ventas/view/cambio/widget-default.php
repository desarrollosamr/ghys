...
<?php foreach($_SESSION["cambioin"] as $p):
	...
	<tr >
		...
		<td><b>$ <?php  $pt = $productin->price_out*$p["q"]*(1-$p["d"]/100); $totalin +=$pt; echo number_format($pt); ?></b></td>
...
<table class="table table-bordered table-hover">
	...
	<?php foreach($_SESSION["cambioout"] as $p):
		...
		<tr >
			...
			<td><b>$ <?php  $pt = $productout->price_out*$p["q"]*(1-$p["d"]/100); $totalout +=$pt; echo number_format($pt); ?></b></td>
