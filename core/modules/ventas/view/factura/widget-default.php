...
if(isset($_GET["id"]) && $_GET["id"]!=""):?>
	...
	<br><table style="width: 160px;" class="table">
	<thead>
		<th><font size="1px">Cod</font></th>
		<th><font size="1px">Cant</font></th>
		<th><font size="1px">Descripcion</font></th>
		<th><font size="1px">Talla</font></th>
		<th><font size="1px">Dto</font></th>
		<th><font size="1px">Valor</font></th>
	</thead>
<?php
	foreach($operations as $operation){
...
?>
<tr>
	<td><font size="2px"><?php echo $product->id ;?></font></td>
	<td><font size="2px"><?php echo $operation->q ;?></font></td>
	<td><font size="2px"><?php echo $product->name ;?></font></td>
	<td><font size="2px"><?php if($product->talla_id!=null){echo $product->getTalla()->name;}else{ echo "<center>----</center>"; } ?></font></td>
	<td> <font size="2px"><?php echo $operation->d; ?></font>%</td>
